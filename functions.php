...
function zifer_theme_setup(){
	...
	// load_theme_textdomain( 'zerif-lite', get_stylesheet_directory() . '/languages' );
...
function zifer_enqueue_scripts(){ 
	...
	//wp_enqueue_style( 'zifer-style', get_stylesheet_uri() );
...
*/
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'zerif_latestnews_background', array(
			...
			'label'    => __( 'Background', 'zerif-lite' ),
	...
	$wp_customize->add_setting( 'zerif_bigtitle_bluebutton_label', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('First button','zerif-lite')));

	$wp_customize->add_control( 'zerif_bigtitle_bluebutton_label', array(

			'label'    => __( 'Blue button label', 'zerif-lite' ),
	...
	$wp_customize->add_control( 'zerif_bigtitle_bluebutton_url', array(
			...
			'label'    => __( 'Blue button link', 'zerif-lite' ),
	...
	$wp_customize->add_section( 'zerif_about_section' , array(
			...
			'title'       => __( 'About section', 'zerif-lite' ),
	...
	$wp_customize->add_setting( 'zerif_about_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('About the author ','zerif-lite')));
	...
	$wp_customize->add_section( 'zerif_customcategory_section' , array(
			...
			'title'       => __( 'Custom category section', 'zerif-lite' ),
	...
	$wp_customize->add_setting( 'zerif_customcategory_title', array('sanitize_callback' => 'zerif_sanitize_text','default' => __('Featured posts','zerif-lite')));
...
/**
 * Include from children if exist , 
 * if not include from parent
 */
...
function zerif_posted_on() {
	...
	printf( __( '<span class="byline"> by %2$s</span><span class="posted-on"> on %1$s</span><span class="category-of"> in %3$s</span>', 'zerif-lite' ),
